# genpark-autonomous-agent-eval-trajectory-analyzer-skill
...
> **GenPark AI Agent Skill** -- Autonomous agent evaluation framework tracking hallucination & loops (AgentOps style)
